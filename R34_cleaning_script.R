...
setwd("~/Downloads/ManagingAnxiety_FINAL/ManagingAnxiety_final/Raw Data")
...
#------------------------------------------------------------------------------#
trig <- read.csv("AnxietyTriggers_recovered_Feb_02_2019.csv", header = TRUE)
...
tasklog <- read.csv("TaskLog_02_02_2019.csv", header = TRUE) #replace with raw table
